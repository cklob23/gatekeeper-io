...
async function getSmtpSettings() {
  ...
  return {
    ...
    companyName: s.company_name || "Gatekeeper.io",
...
export async function POST(request: Request) {
  try {
    ...
    let resetLink = `${process.env.NEXT_PUBLIC_APP_URL ? process.env.NEXT_PUBLIC_APP_URL : "http://localhost:3000"}/kiosk/reset-password`
    // ---------- send email via SMTP ----------
